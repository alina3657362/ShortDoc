...
class LlmService:
    ...
    def build_prompt(document_text: str) -> str:
        return f"""
                    ...
                    Требования:
                    1. summary — строка
                    2. сохраняй переносы строк \\n
                    3. не добавляй текст вне JSON
                    4. Удали технические строки, не несущие смысловой нагрузки:
                    ...
                    5. Если строка относится к содержанию документа, а не к подписному блоку, сохраняй её.
